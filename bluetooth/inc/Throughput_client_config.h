#ifndef _THROUGHPUT_CLIENT_CONFIG_H_
#define _THROUGHPUT_CLIENT_CONFIG_H_
...
/* Number of services requests from the Throughput_client demo */
...
#define THROUGHPUT_CLIENT_MAX_ATT_SIZE	(128)
#define APP_MAX_ATT_SIZE	  MAX_CHAR_LEN(OTA_MAX_ATT_SIZE,  THROUGHPUT_CLIENT_MAX_ATT_SIZE)

/* Number of links needed for the Throughput_client demo: 1 */
...
*/
/* Number of GATT attributes needed for the Throughput_client demo */
#define NUM_GATT_ATTRIBUTES	(DEFAULT_NUM_GATT_ATTRIBUTES + NUM_APP_GATT_ATTRIBUTES)

/* Number of GATT services needed for the Throughput_client demo */
