...
/* Number of services requests from the Throughtput demo */
#define NUM_APP_GATT_SERVICES	(2)

/* Number of attributes requests from the Throughtput demo */
...
#define THROUGHTPUT_MAX_ATT_SIZE	(128)
#define APP_MAX_ATT_SIZE	  MAX_CHAR_LEN(OTA_MAX_ATT_SIZE,  THROUGHTPUT_MAX_ATT_SIZE)

/* Number of links needed for the Throughtput demo: 1 */
