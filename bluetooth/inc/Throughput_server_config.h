#ifndef _THROUGHPUT_SERVER_CONFIG_H_
#define _THROUGHPUT_SERVER_CONFIG_H_
...
/* Number of services requests from the Throughput_server demo */
#define NUM_APP_GATT_SERVICES	(2)

/* Number of attributes requests from the Throughput_server demo */
...
#define THROUGHPUT_SERVER_MAX_ATT_SIZE	(128)
#define APP_MAX_ATT_SIZE	  MAX_CHAR_LEN(OTA_MAX_ATT_SIZE,  THROUGHPUT_SERVER_MAX_ATT_SIZE)

/* Number of links needed for the Throughput_server demo: 1 */
...
#define MAX_NUMBER_ATTRIBUTE_SERVICE2	(7)

/* Number of characteristics defined by the user application */
/*#define NUMBER_CHAR_SERVICE1	(2)
#define NUMBER_CHAR_SERVICE2	(1)
*/
/* Number of GATT attributes needed for the Throughput_server demo */
#define NUM_GATT_ATTRIBUTES	(DEFAULT_NUM_GATT_ATTRIBUTES + NUM_APP_GATT_ATTRIBUTES)

/* Number of GATT services needed for the Throughput_server demo */
