...
#define NUM_APP_GATT_ATTRIBUTES	(105)
...
#define THROUGHPUT_MAX_ATT_SIZE	(128)
#define APP_MAX_ATT_SIZE	  MAX_CHAR_LEN(OTA_MAX_ATT_SIZE,  THROUGHPUT_MAX_ATT_SIZE)

/* Number of links needed for the Throughput demo: 1 */
...
#define MAX_NUMBER_ATTRIBUTE_SERVICE2	(100)

/* Number of characteristics defined by the user application */
/*#define NUMBER_CHAR_SERVICE1	(2)
#define NUMBER_CHAR_SERVICE2	(33)
*/
/* Number of GATT attributes needed for the Throughput demo */
#define NUM_GATT_ATTRIBUTES	(DEFAULT_NUM_GATT_ATTRIBUTES + NUM_APP_GATT_ATTRIBUTES)

/* Number of GATT services needed for the Throughput demo */
...
#define ATT_VALUE_ARRAY_SIZE	(1924 + OTA_ATT_VALUE_ARRAY_SIZE)
